...
getConvFac <-
  function(conversion = "m2cm") {
    ...
    convFac <- if (is.character(conversion)) {
      ...
      idxFT2IN <- conversion %in% c("ft2in",
                                    "ft2inch",
                                    "feet2in",
                                    "feet2inch",
                                    "foot2in",
      ...
      idxAll <-
        idxMM2MM |
        idxMM2CM |
        idxMM2M | idxMM2KM | idxMM2IN | idxMM2FT | idxMM2YD |
        idxCM2MM |
        idxCM2CM |
        idxCM2M | idxCM2KM | idxCM2IN | idxCM2FT | idxCM2YD |
        idxM2MM  |
        idxM2CM  |
        idxM2M  | idxM2KM  | idxM2IN  | idxM2FT  | idxM2YD  |
        idxKM2MM |
        idxKM2CM |
        idxKM2M | idxKM2KM | idxKM2IN | idxKM2FT | idxKM2YD |
        idxIN2MM |
        idxIN2CM |
        idxIN2M | idxIN2KM | idxIN2IN | idxIN2FT | idxIN2YD |
        idxFT2MM |
        idxFT2CM |
        idxFT2M | idxFT2KM | idxFT2IN | idxFT2FT | idxFT2YD |
        idxYD2MM |
        idxYD2CM |
        idxYD2M | idxYD2KM | idxYD2IN | idxYD2FT | idxYD2YD
      if (!all(idxAll)) {
        warning(c(
          'Conversion type(s) "',
          paste(conversion[!idxAll], collapse = " "),
      ...
      res
    } else if (is.numeric(conversion)) {
      # factor is given directly
      if (any(conversion <= 0)) {
